...
def initialize_optimizer(
    ...
    if schedule_opts is None:
        ...
        # schedule_opts = {"name": "OneCycleLR", "max_lr":learning_rate, "pct_start": 0.1,  # noqa: E501
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    # pytorch > 1.2 has now also a AdamW (but without the option to set bias_correction = False,  # noqa: E501
                    ...
                    raise AttributeError(  # noqa: B904
                        f"Optimizer '{optimizer_name}' not found in 'torch', 'transformers', 'apex' or 'local imports"  # noqa: E501
                    )  # noqa: B904, E501
    ...
    try:
        ...
        try:
            ...
            scheduler_translations = {
                ...
                "ConstantWarmup": "get_constant_schedule_with_warmup",  # noqa: E501
                "Constant": "get_constant_schedule",
                "CosineWarmup": "get_cosine_schedule_with_warmup",
                "CosineWarmupWithRestarts": "get_cosine_with_hard_restarts_schedule_with_warmup",  # noqa: E501
            }
...
def _init_amp(model, device, optimizer=None, use_amp=None):
    ...
    if use_amp and optimizer:
        if AMP_AVAILABLE:
            ...
            logger.warning(
                f"Can't find AMP although you specificed to use amp with level {use_amp}. Will continue without AMP ..."  # noqa: E501
            )  # noqa: E501
